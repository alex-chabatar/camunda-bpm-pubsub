...
class SendMessageTest {
  ...
  public void setUp() {
    ...
    var pubSubConfiguration = PubSubConfigurationFactory.getInstance().get();
  ...
  void ensureProcess() {
    ...
    var projectName = "test-project-new";
    var topicName = "test-topic-new";
    var data = "{ \"message\": \"Hello PubSub\" }";
    ...
    var expectedPubSubMessage = PubSubMessage.builder()
